...
class TomasTextFieldWithTextTextField extends StatelessWidget {
  ...
  const TomasTextFieldWithTextTextField({
  ...
  Widget build(BuildContext context) {
    return Expanded(
      flex: flex,
      child:
          BlocBuilder<TomasTextFieldWithTextCubit, TomasTextFieldWithTextState>(
        builder: (context, state) {
          return TextFormField(
            minLines: minLines,
            maxLines: maxLines ?? (minLines != null ? 50 : null),
