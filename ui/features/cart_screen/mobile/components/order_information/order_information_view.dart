...
import 'package:tomas_matres/ui/components/tomas_dropdown_menu_with_text/mobile/tomas_dropdown_menu_with_text_mobile.dart';
...
import 'package:tomas_matres/ui/components/tomas_text_field_with_text/mobile/tomas_text_field_with_text_mobile.dart';
...
import 'package:tomas_matres/ui/features/cart_screen/mobile/components/cart_order/cart_order_view.dart';
import 'package:tomas_matres/ui/features/cart_screen/mobile/components/order_information/components/receiving_method/receiving_method_view.dart';
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TomasTextFieldWithTextMobile(
                        ...
                        regExp: phoneRegExp,
                        errorText: LocaleKeys.kTextRequiredPhoneNumber.tr(),
                    ...
                    BlocBuilder<ReceivingMethodBloc, ReceivingMethodState>(
                      builder: (context, state) {
                        ...
                        Zone rawZone = orderInformationState.zones.firstWhere(
                            (element) =>
                                element.zoneId == "2722"); // Moscow obl
                        ...
                        return Column(
                          ...
                          children: [
                            SizedBox(
                              height: state.isDelivery ? 56 : 24,
                            ),
                            if (state.isDelivery)
                              TomasDropdownMenuWithTextMobile(
                                label: LocaleKeys.kTextZone.tr(),
                                initValue: zone,
                                data: List.generate(
                                    orderInformationState.zones.length,
                                    (index) {
                                ...
                                validator: (value) => validateZone(value),
                            ...
                            if (state.isDelivery)
                              TomasTextFieldWithTextMobile(
                                  ...
                                  hintText: LocaleKeys.kTextCityHint.tr(),
                                  validator: (value) => validate(value)),
                            if (state.isDelivery)
                              const SizedBox(
                                height: 32,
                            ...
                            if (state.isDelivery)
                              TomasTextFieldWithTextMobile(
                                  ...
                                  label: LocaleKeys.kTextContactsAddress.tr(),
                                  hintText: LocaleKeys
                    ...
                    TomasTextFieldWithTextMobile(
                      ...
                      hintText: LocaleKeys.kTextCommentOnTheOrder.tr(),
                      minLines: 4,
                    ),
                    const SizedBox(
                      height: 56,
                    ...
                    TomasFilledButton(
                      ...
                      borderRadius: 40,
                      textStyle: UiConstants.kTextStyleButtonRegular
                    ...
                    RichText(
                      text: TextSpan(
                        text: LocaleKeys.kTextCartOrderInformationNote1.tr(),
                        style: UiConstants.kTextStyleText5
                            .copyWith(color: UiConstants.kColorBase04),
                        children: [
                          TextSpan(
                              text: LocaleKeys.kTextCartOrderInformationNote2
                                  .tr(),
                              style: UiConstants.kTextStyleText5
                          ...
                          TextSpan(
                              text: LocaleKeys.kTextCartOrderInformationNote3
                                  .tr()),
                          TextSpan(
                              text: LocaleKeys.kTextCartOrderInformationNote4
                                  .tr(),
                              style: UiConstants.kTextStyleText5
                                  .copyWith(color: UiConstants.kColorPrimary),
                              recognizer: TapGestureRecognizer()
                          ...
                          TextSpan(
                              text: LocaleKeys.kTextCartOrderInformationNote5
                                  .tr()),
                        ],
                      ),
                    ),
